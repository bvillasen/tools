...
nPoints = 1000
initialR = 4
viewXmin, viewXmax = -2*initialR, 2*initialR
viewYmin, viewYmax = -2*initialR, 2*initialR
viewZmin, viewZmax = -2*initialR, 2*initialR
showGrid = False
windowTitle = " CUDA N-body simulation     particles={0}".format(nPoints) 
